...
APR research has moved toward systems called "Code World Models" that simulate the program's execution environment, treating code generation as a state-transition prediction task rather than text completion.
