...
\begin{itemize}\setlength{\itemsep}{6pt}
  \item \textbf{Frontier models}: \texttt{DeepSeek-V4-Pro}, \texttt{gpt-5.4}, \texttt{claude-sonnet-4.6}
  \item \textbf{Small open-source models}: \texttt{Qwen2.5-Coder-7B-Instruct}
\end{itemize}
